...
def index(request):
    return render(request, "auctions/index.html", {
        ...
        "header": "Тут ви бачите всі активні списки."
    })
...
def inactive(request):
    return render(request, "auctions/index.html", {
        ...
        "bids": Bid.objects.all(),
        "header": "Тут ви бачите всі неактивні списки."
    })
    ...
    if request.method == "POST":
        ...
        if not request.user.is_authenticated:
            return render(request, "auctions/create.html", {
                "message": "Ви не можете створити список, не увійшовши до системи."
            })
    ...
    if request.method == 'POST':
        ...
        if value is None and comment is None:
            return render(request, "auctions/error.html", {
                "error": "Або прокоментуйте, або зробіть ставку."
            })
...
def close(request, listing_id):
    ...
    if l.user == request.user and not b is None:
        ...
        return render(request, "auctions/error.html", {
            "error": "Ви не можете закрити чужі списки."
        })
